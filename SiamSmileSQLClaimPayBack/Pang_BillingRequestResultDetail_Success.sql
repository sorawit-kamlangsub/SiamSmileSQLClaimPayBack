...
--)
AND hi.IsActive = 1
AND hi.ClaimHeaderGroupCode IN ('PCHO-541-68090149-0','PCHO-541-68090149-1')
...
WHERE ClaimHeaderGroupCode IN ('PCHO-541-68090149-0','PCHO-541-68090149-1')
...
WHERE cid.ClaimHeaderGroupCode IN ('PCHO-541-68090149-0','PCHO-541-68090149-1')

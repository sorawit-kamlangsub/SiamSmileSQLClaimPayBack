...
-- Description: แก้ไข cptMisc เพิ่ม rn payment type และ relationDetail
-- =============================================
	...
	LEFT JOIN (
		...
		FROM (
			SELECT
				...
				ROW_NUMBER() OVER (
					PARTITION BY cm.ClaimMiscId, cptMisc.BankAccountName, cptMisc.PaymentTypeName, cptMisc.RelationDetail

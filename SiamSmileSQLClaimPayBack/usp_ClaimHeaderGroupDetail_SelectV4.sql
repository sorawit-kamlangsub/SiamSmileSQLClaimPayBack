...
AS
BEGIN
	EXECUTE [Claim].[usp_ClaimHeaderGroupDetail_SelectV5] @ProductGroupId,@InsuranceId,@ClaimGroupTypeId,@BranchId,@CreateByUser_Code,@IndexStart,@PageSize,@SortField,@OrderType,@SearchDetail,@IsShowDocumentLink;	
--	SET NOCOUNT ON;

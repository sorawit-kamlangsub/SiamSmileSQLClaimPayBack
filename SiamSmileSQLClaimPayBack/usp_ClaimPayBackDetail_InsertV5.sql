USE [ClaimPayBack]
GO
/****** Object:  StoredProcedure [Claim].[usp_ClaimPayBackDetail_InsertV5]    Script Date: 9/10/2568 11:24:56 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
-- Author:		Sorawit Kamlangsub (อ้างอิง usp_ClaimPayBackDetail_InsertV4)
-- Description:	Add ClaimHospital, ClaimCompensate and ClaimMisc บันทึกตั้งเบิกเคลม
-- Create date: 2025-10-21
-- =============================================
ALTER PROCEDURE [Claim].[usp_ClaimPayBackDetail_InsertV5]

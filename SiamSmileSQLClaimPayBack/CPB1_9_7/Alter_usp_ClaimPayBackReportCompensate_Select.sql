USE [ClaimPayBack]
GO
/****** Object:  StoredProcedure [dbo].[usp_ClaimPayBackReportCompensate_Select]    Script Date: 7/21/2026 11:09:30 AM ******/
SET ANSI_NULLS ON
GO
...
-- Update date: 2026-07-21 Sorawit.k
-- Description:	เพิ่มคอลัมน์ AppId สถานศึกษา สถานะของกรมธรรม์ 
-- =============================================

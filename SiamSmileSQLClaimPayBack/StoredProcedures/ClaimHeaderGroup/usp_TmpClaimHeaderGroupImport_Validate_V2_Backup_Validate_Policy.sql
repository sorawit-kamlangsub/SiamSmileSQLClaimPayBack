...
/****** Object:  StoredProcedure [dbo].[usp_TmpClaimHeaderGroupImport_Validate_V2_Backup_Validate_Policy]    Script Date: 9/21/2026 4:23:22 PM ******/
SET ANSI_NULLS ON
GO
...
-- Update date: 2026-08-11 08:44 เพิ่มการ validate เลขกรมธรรม์ตามเงื่อนไขที่กำหนดใน @MapAdmitTypeWithPolicy Sorawit kamlangsub
...
-- =============================================
ALTER PROCEDURE [dbo].[usp_TmpClaimHeaderGroupImport_Validate_V2_Backup_Validate_Policy]
	@TmpCode VARCHAR(20)

USE [ClaimPayBack]
GO
/****** Object:  StoredProcedure [Claim].[usp_ClaimHeaderGroupDetail_SelectV3]    Script Date: 3/9/2026 2:19:44 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	EXECUTE [Claim].[usp_ClaimHeaderGroupDetail_SelectV4] @ProductGroupId,@InsuranceId,@ClaimGroupTypeId,@BranchId,@CreateByUser_Code,@IndexStart,@PageSize,@SortField,@OrderType,@SearchDetail,@IsShowDocumentLink,@ProductTypeId,@ClaimPayBackTypeId;	
